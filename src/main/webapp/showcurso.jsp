...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1 class="text-center">Curso Registrado</h1>
            <jsp:useBean id="cursos" scope="request" class="com.emergentes.Curso" />
            
            <div class="row justify-content-md-center">
                <div class="col-md-auto">
                    <h4 style="font-weight: normal;">
                        <b>Nombre :</b> 
                        <i><jsp:getProperty name="cursos" property="nombre" /></i>
                    </h4>
                    <h4 style="font-weight: normal;">
                        <b>Apellidos :</b> 
                        <i><jsp:getProperty name="cursos" property="apellidos" /></i>
                    </h4>
                    <h4 style="font-weight: normal;">
                        <b>Cursos :</b> 
                        <i><jsp:getProperty name="cursos" property="curso" /></i>
                    </h4>
                    <br><br>
