...
<html>
    ...
    <body>
        <div class="container">
            ...
            <h1 class="text-center">Producto Registrado</h1>
            <jsp:useBean id="productos" scope="request" class="com.emergentes.Producto" />
            
            <div class="row justify-content-md-center">
                <div class="col-md-auto">
                    <h4 style="font-weight: normal;">
                        <b>Producto :</b> 
                        <i><jsp:getProperty name="productos" property="producto" /></i>
                    </h4>
                    <h4 style="font-weight: normal;">
                        <b>Categoria :</b> 
                        <i><jsp:getProperty name="productos" property="categoria" /></i>
                    </h4>
                    <h4 style="font-weight: normal;">
                        <b>Existencia :</b> 
                        <i><jsp:getProperty name="productos" property="existencia" /></i>
                    </h4>
                    <h4 style="font-weight: normal;">
                        <b>Precio :</b> 
                        <i><jsp:getProperty name="productos" property="precio" /></i>
                    </h4>
                    <br><br>
