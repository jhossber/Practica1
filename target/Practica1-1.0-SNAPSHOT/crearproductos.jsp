        ...
        <div class="container">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-auto">
                    <form action="ProcesaProductoServlet" method="POST">
                        <div class="form-group">
                          <label for="productos">Productos</label>
                          <input type="text" class="form-control" name="producto" id="productos">                          
                        </div>
                        <div class="form-group">
                            <label for="catselect">Categoria</label>
                            <select class="form-control" name="categoria" id="catselect">
                              <option>Seleccionar</option>
                              <option value="nuevo">Nuevo</option>
                              <option value="estrella">Estrella</option>
                              <option value="temporada">Temporada</option>
                              <option value="seguidores">Seguidores</option>
                              <option value="baja">A la Baja</option>                              
                            </select>
                        </div>
                        <div class="form-group">
